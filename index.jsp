...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/select_option1.css">
...
<section class="bannercontainer">
  ...
  <div id="rev_slider_wrapper1" class="rev_slider_wrapper fullscreen-container" data-alias="christmas-snow-scene" data-source="gallery" style="background-color:transparent;padding:0px;">
    ...
    <div id="rev_slider_container" class="rev_slider custom_rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
      <ul>
        ...
        <li data-transition="parallaxvertical" >
          <!-- MAIN IMAGE -->
          <img src="assets/img/slider-01.jpg" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
    ...
    <li data-transition="parallaxvertical">
      <!-- MAIN IMAGE -->
      <img src="assets/img/slider-02.jpg" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
    ...
    <li data-transition="parallaxvertical">
      <!-- MAIN IMAGE -->
      <img src="assets/img/slider-03.jpg" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
    ...
    <li data-transition="parallaxvertical">
      <!-- MAIN IMAGE -->
      <img src="assets/img/slider-04.jpg" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
    ...
    <section class="mainContentSection packagesSection">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="thumbnail deals">
              <img src="assets/img/deal-02.jpg" alt="deal-image">
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="thumbnail deals">
              <img src="assets/img/deal-03.jpg" alt="deal-image">
          ...
          <div class="col-xs-12">
            <div class="media destinations">
              <a class="media-left" href="destination-cities.html">
                <img class="media-object" src="assets/img/destination.jpg" alt="Destination">
              </a>
      ...
      <div class="container">
        ...
        <div class="row isotopeContainer">
            <div class="col-sm-4 isotopeSelector asia">
              <article class="">
                <figure>
                  <img src="assets/img/packages-1.jpg" alt="">
            ...
            <div class="col-sm-4 isotopeSelector america africa">
              <article class="">
                <figure>
                  <img src="assets/img/packages-2.jpg" alt="">
                  <h4>Maecenas Tour</h4>
                  <div class="overlay-background">
                    <div class="inner"></div>
                  </div>
            ...
            <div class="col-sm-4 isotopeSelector africa">
              <article class="">
                <figure>
                  <img src="assets/img/packages-3.jpg" alt="">
                  <h4>Lobortis Tour</h4>
                  <div class="overlay-background">
                    <div class="inner"></div>
                  </div>
            ...
            <div class="col-sm-4 isotopeSelector asia america">
              <article class="">
                <figure>
                  <img src="assets/img/packages-4.jpg" alt="">
            ...
            <div class="col-sm-4 isotopeSelector america">
              <article class="">
                <figure>
                  <img src="assets/img/packages-5.jpg" alt="">
                  <h4>Nullam Tour</h4>
                  <div class="overlay-background">
                    <div class="inner"></div>
                  </div>
            ...
            <div class="col-sm-4 isotopeSelector africa asia">
              <article class="">
                <figure>
                  <img src="assets/img/packages-6.jpg" alt="">
...
<script src="assets/js/jquery.selectbox-0.1.3.min.js"></script>
<script src="assets/js/bootstrap-datepicker.js"></script>
<script src="assets/js/waypoints.min.js"></script>
<script src="assets/js/jquery.counterup.min.js"></script>
<script src="assets/js/isotope.min.js"></script>
<script src="assets/js/jquery.fancybox.pack.js"></script>
<script src="assets/js/isotope-triger.js"></script>
