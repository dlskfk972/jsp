      ...
      <div class="row">
        <div class="col-sm-3 col-xs-12">
          <div class="footerContent">
            <a href="index.html" class="footer-logo"><img src="assets/img/logo-color-sm.png" alt="footer-logo"></a>
        ...
        <div class="col-sm-3 col-xs-12">
          <div class="footerContent imgGallery">
            ...
            <div class="row">
              <div class="col-xs-4">
                <a class="fancybox-pop" href="assets/img/gallery-1.jpg"><img src="assets/img/thumb-gallery-1.jpg" alt="image"></a>
              </div>
              <div class="col-xs-4">
                <a class="fancybox-pop" href="assets/img/gallery-2.jpg"><img src="assets/img/thumb-gallery-2.jpg" alt="image"></a>
              </div>
              <div class="col-xs-4">
                <a class="fancybox-pop" href="assets/img/gallery-3.jpg"><img src="assets/img/thumb-gallery-3.jpg" alt="image"></a>
              </div>
              <div class="col-xs-4">
                <a class="fancybox-pop" href="assets/img/gallery-4.jpg"><img src="assets/img/thumb-gallery-4.jpg" alt="image"></a>
              </div>
              <div class="col-xs-4">
                <a class="fancybox-pop" href="assets/img/gallery-5.jpg"><img src="assets/img/thumb-gallery-5.jpg" alt="image"></a>
              </div>
              <div class="col-xs-4">
                <a class="fancybox-pop" href="assets/img/gallery-6.jpg"><img src="assets/img/thumb-gallery-6.jpg" alt="image"></a>
              </div>
            </div>
          </div>
        </div>
